...
\begin{table}[!htbp] \centering 
  \caption{OLS Regression Results for Manufacturing Value Added (\% GDP), Uzbekistan, 2010--2023. Source: World Bank WDI; OEC/BACI. Processed by author calculations via R.} 
  \label{tab:ols_mfg} 
