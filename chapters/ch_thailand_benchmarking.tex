...
\begin{figure}[H]
 ...
 \caption{Comparative Manufacturing Trajectories: Thailand, Vietnam, and Uzbekistan, Aligned to Reform Year Zero. Panel~A: Manufacturing VA (\%~GDP) --- Thailand starts $\sim$19\%, Vietnam $\sim$20\%, Uzbekistan $\sim$14\% at year zero. Panel~B: FDI inflows (\%~GDP) --- Vietnam's surge after year~6 reflects Samsung-era anchor investment; Uzbekistan remains flat. Panel~C: Logistics Performance Index (sparse; available survey years only). Source: World Bank WDI; author reform-year alignment.}
