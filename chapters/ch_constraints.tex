...
\begin{table}[H]
 \centering
 \caption{Transit Cost Comparison, Uzbekistan and Benchmark Economies, 2022. Source: World Bank Logistics Performance Index 2023; IFC Cost of Doing Business. Processed by author compilation via R.}
...
Three infrastructure investments could materially reduce this constraint. The China-Kyrgyzstan-Uzbekistan (CKU) railway is no longer merely speculative: construction was officially launched at a trilateral ceremony on 27 December 2024, and a financing agreement was signed on 16 December 2025 for a project estimated at \$4.7 billion, including an approximately \$2.3 billion 35-year loan from a Chinese bank consortium led by China Development Bank and Eximbank \citep{cku2024launch, cku2025financing}. The 486~km route from Kashgar through Kyrgyzstan to Andijan is engineering-intensive, with reporting indicating dozens of bridges and tunnels across the Kyrgyz section. This creates a plausible logistics breakthrough for Uzbekistan, but the financing structure also requires analytical caution: China's 51\% equity stake and Kyrgyzstan's debt exposure mean the project could deepen dependency if transit revenues disappoint.

The Trans-Caspian International Transport Route (Middle Corridor) --- connecting China via Kazakhstan, the Caspian Sea, Azerbaijan, Georgia, and Turkey to European markets --- has accelerated since Russia's 2022 invasion of Ukraine disrupted the northern route. Cargo volumes rose from roughly 0.8--0.9 million tonnes in 2020--2021 to 2.76 million tonnes in 2023 and about 4.5 million tonnes in 2024; container traffic also rose sharply in 2024 \citep{middlecorridor2024, rand2024middlecorridor}. This corridor could accommodate Uzbek export cargo at scale if Uzbekistan develops feeder rail and customs integration. Air freight from Navoiy (the Navoiy model discussed in Section~\ref{sec:sez}) offers a partial solution for high-value products.

\begin{figure}[H]
 \centering
 \includegraphics[width=0.88\textwidth]{figures/fig_newB_middle_corridor.png}
 \caption{Middle Corridor Freight Growth, 2018--2025. Cargo volumes are approximate author estimates compiled from TITR-related public reporting, Ports Europe, and RAND; 2024--2025 container figures are preliminary. Source: TITR-related public reporting; Ports Europe; RAND. Processed by author calculations via R.}
 \label{fig:middle_corridor}
\end{figure}

\subsection{Russia Sanctions, Re-Exports, and Corridor Substitution}

The post-2022 sanctions environment is a distinct structural shock rather than a background condition. It affects Uzbekistan through three channels. First, some Russian and Russia-oriented firms relocated operations to Uzbekistan, raising demand for light manufacturing, services, and logistics. Second, re-export flows of Western goods through Central Asia into sanctioned Russia may inflate bilateral trade figures without representing durable domestic upgrading. Third, the Middle Corridor gained strategic importance as the northern Eurasian route through Russia became politically and commercially riskier. These effects strengthen Uzbekistan's short-run trade volumes but complicate interpretation: some post-2022 growth reflects rerouting and sanctions arbitrage rather than the establishment of relational production networks. The dissertation therefore treats Russia-related trade growth as a temporary opportunity window, not as evidence of permanent GVC upgrading.
...
\begin{table}[H]
 \centering
 \caption{Energy Infrastructure, Uzbekistan and Comparators. Source: World Bank WDI; IEA; World Bank Enterprise Surveys. Processed by author compilation via R.}
 \label{tab:energy}
 \small
 \begin{tabular}{@{}lcccc@{}}
 \toprule
...
These political economy constraints are not unique to Uzbekistan --- Vietnam and Thailand both experienced similar tensions between reform coalitions and rent-seeking incumbents. The difference is that Vietnam's WTO accession (2007) and Thailand's ASEAN obligations provided binding external commitment mechanisms that constrained reversal and reduced the space for elite capture. Uzbekistan's WTO accession process has now moved from abstract aspiration to final-stage transition: WTO reporting in November 2025 described ``steady progress'' toward the MC14 2026 accession target, while the EU--Uzbekistan EPCA signed in October 2025 adds an additional rule-bound external anchor \citep{wto2025uzbekistan, uzbekistan2025epca}. The policy priority is therefore no longer simply acceleration, but managing the domestic adjustment required to make accession credible and irreversible.

\begin{figure}[H]
 \centering
 \includegraphics[width=0.90\textwidth]{figures/fig_newA_wto_tracker.png}
 \caption{Uzbekistan WTO Accession Progress Tracker, 2020--2026. Source: WTO accession documents; EU and Uzbekistan EPCA reporting. Processed by author compilation via R.}
 \label{fig:wto_tracker}
\end{figure}
...
\begin{figure}[H]
 ...
 \caption{Structural Constraint Prioritisation Matrix. Source: World Bank; IFC; ADB. Processed by author assessment via R.}
