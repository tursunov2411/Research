...
\begin{figure}[H]
 ...
 \caption{World Governance Indicators, Uzbekistan and Comparators at Comparable Reform Stages. Source: World Bank WGI; ICRG political risk indices. Processed by author calculations via R.}
 \label{fig:wgi_comparison}
\end{figure}

\begin{table}[H]
 \centering
 \caption{World Governance Indicators, Comparative Percentile Ranks. Source: World Bank WGI. Processed by author calculations via R.}
 \label{tab:wgi}
 \small
 \begin{tabular}{@{}lcccc@{}}
 \toprule
...
\begin{table}[H]
 \centering
 \caption{Selected B-READY and Doing Business Indicators, Uzbekistan and Comparators. Source: World Bank B-READY; Doing Business. Processed by author compilation via R.}
 \label{tab:bready}
 \small
 \begin{tabular}{@{}lccc@{}}
 \toprule
...
\begin{table}[H]
 \centering
 \caption{Human Capital Indicators, Uzbekistan and Comparators. Source: World Bank; ILO; related human capital datasets. Processed by author compilation via R.}
...
\begin{figure}[H]
 ...
 \caption{Institutional Readiness Radar, Uzbekistan vs.\ Vietnam at Reform Year +6. Source: World Bank; UNCTAD; ILO. Processed by author calculations via R.}
