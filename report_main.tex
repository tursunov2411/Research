...
The dissertation proceeds as follows. I BOB (Kirish) establishes the research context and structure. II BOB (Adabiyotlar Sharhi) reviews the theoretical literature on FDI-led industrialisation, GVC governance, and the economics of landlocked developing countries. III BOB (Metodologiya) describes the data, core empirical methodology, and the critical realist research design underpinning the mixed-method approach. IV BOB (Tahlil va Natijalar) presents the comprehensive empirical analysis, including structural break testing, revealed comparative advantage, network mapping, comparative benchmarking, institutional diagnostics, and panel regression results. Finally, V BOB (Xulosa va Takliflar) synthesises the findings and derives five actionable policy implications to overcome the constraints on Uzbekistan's industrial upgrading.
