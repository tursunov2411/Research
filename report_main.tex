...
% ═══════════════════════════════════════════════════════════════════════════════
\section{I BOB: Kirish (Introduction)}
% ═══════════════════════════════════════════════════════════════════════════════
...
% ═══════════════════════════════════════════════════════════════════════════════
\section{II BOB: Adabiyotlar Sharhi (Literature Review)}
\input{chapters/ch_literature_review}
...
% ═══════════════════════════════════════════════════════════════════════════════
\section{IV BOB: Tahlil va Natijalar (Analysis and Results)}
...
Figure \ref{fig:comparative_trajectory} reveals three systematic gaps. In manufacturing value added (Panel A), Uzbekistan and Vietnam begin at comparable levels (approximately 14\% of GDP at reform year 0)\footnote{It is important to note a measurement asymmetry in this comparison. Vietnam's year 0 (2001) represents its Bilateral Trade Agreement with the US, which opened a single massive market. A more rigorous comparator for Uzbekistan's 2017 multilateral liberalisation would be Vietnam's WTO accession in 2007. By Vietnam's WTO+6 stage (2013), its manufacturing VA was approximately 17--18\% of GDP, which makes Uzbekistan's trajectory look slightly more favourable. The 2001 baseline is used here primarily to capture the very beginning of Vietnam's steep manufacturing ascent.} and Uzbekistan's trajectory in years 0--4 broadly tracks Vietnam's. However, Uzbekistan appears to plateau near 19--20\% from year 4 onward, while Vietnam continued rising to higher manufacturing intensity (though data alignment issues introduce some uncertainty here).
...
Lagged FDI (t-1) enters positively but is statistically insignificant ($\beta = 0.002$, $p = 0.15$), whereas the intermediate goods import share is highly significant ($\beta = 2.34$, $p < 0.05$). This is consistent with a delayed effect of investment on productive capacity. The two-period lag (t-2) is less precisely estimated, suggesting that the primary transmission operates within one year --- plausibly through capacity utilisation and supply-chain activation of already-committed investments rather than entirely new greenfield construction.
...
% ═══════════════════════════════════════════════════════════════════════════════
\section{V BOB: Xulosa va Takliflar (Conclusion and Policy Implications)}
